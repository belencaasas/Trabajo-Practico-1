...
class Batalla{
    private: 
        unique_ptr<Personaje> jugador1; 
        unique_ptr<Personaje> jugador2;
    
    public: 
        Batalla(unique_ptr<Personaje> p1 , unique_ptr<Personaje> p2); //inicializa los personajes q van a pelar 
        ...
        void mostrarAccion(Personaje* atacante, OpcionAtaque opcion, Personaje* defensor); //muestra los movimientos del jugador
